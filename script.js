...
const myNum = input.findIndex(input => input === 2021);
console.log(myNum); //185
console.log(input[myNum]); //2021
    ...
    for(let j=i+1; j< input.length; j++)
        {
            ...
            console.log(`${input[i]} plus ${input[j]} equals 2021 ${input[i] * input[j]}`)
            break;
            }
        }
}
...
//Part 3 go through the list and find the 3 numbers that add to 2021 and multiply them
let num3;
let num4;
let num5;
    ...
    for(let j=i+1; j< input.length; j++)
    {
        for(let k=j+1; k< input.length; k++)
        {
            if(input[i] + input[j] + input[k] == 2021){
                console.log(`${input[i]} plus ${input[j]} plus ${input[k]} equals 2021 ${input[i] * input[j] * input[k]}`)
            }
        }
    }
}
...
//Part 4 go through the list and find the 4 numbers that add to 2021 and multiply them
let num6;
let num7;
let num8;
let num9;
        ...
        for(let k=j+1; k < input.length; k++)
        {
            for(let l=k+1; l < input.length; l++)
            {
                if(input[i] + input[j] + input[k] + input[l] == 2021){
                    console.log(`${input[i]} plus ${input[j]} plus ${input[k]} plus ${input[l]} equals 2021 ${input[i] * input[j] * input[k] * input[l]}`)
                }
            }
        }
    }
...
// console.log(num6 * num7 * num8 * num9); //2765575901970
